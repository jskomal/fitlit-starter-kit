...
describe('Sleep', () => {
  ...
  it('should have a method that returns how many hours a single user slept over the course of week', () => {
    expect(sleep.getSleepTimeInWeek('Jun 26 2019')).to.deep.equal([
      8, 2.1, 8.1, 5.1, 6.2, 6.1, 6.2
    ])
  })

  it("should have a method that returns a user's sleep quality over the course of week", () => {
    expect(sleep.getSleepQualityInWeek('Jun 26 2019')).to.deep.equal([
      2.1, 1, 3, 3.4, 2.4, 3.4, 2.1
    ])
  })
})
